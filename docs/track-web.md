...
```sh
# 1. the four graphs (needs the EdgeTAM checkpoint in ~/dither-video/env)
pip install --target /tmp/pylibs onnx onnxruntime
PYTHONPATH=/tmp/pylibs ../../env/venv/bin/python ../../onnxexport/export_onnx.py \
